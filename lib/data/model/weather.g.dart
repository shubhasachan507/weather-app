...
Weather _$WeatherFromJson(Map<String, dynamic> json) => Weather(
      ...
      sys: json['sys'] == null
          ? null
          : SunPosition.fromJson(json['sys'] as Map<String, dynamic>),
...
SunPosition _$SunPositionFromJson(Map<String, dynamic> json) => SunPosition(
      country: json['country'] as String?,
      sunrise: (json['sunrise'] as num?)?.toInt(),
      sunset: (json['sunset'] as num?)?.toInt(),
    );

Map<String, dynamic> _$SunPositionToJson(SunPosition instance) =>
    <String, dynamic>{
